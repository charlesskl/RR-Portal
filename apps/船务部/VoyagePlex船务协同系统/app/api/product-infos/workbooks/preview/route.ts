...
export async function POST(request:NextRequest) {
  ...
  try { return proxyResponse(await backendFetch(request,"/api/product-infos/workbooks/preview",{method:"POST",headers:{"content-type":request.headers.get("content-type")||"multipart/form-data"},body:await request.arrayBuffer()})); }
